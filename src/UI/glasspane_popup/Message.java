...
public class Message extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdOK = new UI.glasspane_popup.Button();
        cmdCancel = new UI.glasspane_popup.Button();
    ...
    private UI.glasspane_popup.Button cmdCancel;
    private UI.glasspane_popup.Button cmdOK;
