...
public class studyPanel extends javax.swing.JPanel {
    ...
    public void addHocky(String hk){
        cbBox_hocKy.addItem(hk);
    }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cbBox_hocKy, 0, 109, Short.MAX_VALUE))))
                        .addContainerGap())))
        );
    ...
    public void setTableDiem(){
        ...
        modelDiem.setColumnIdentifiers(new Object[]{
            "STT", "Mã môn", "Tên môn", "Số tín chỉ", "Điểm QT", "Điểm GK", 
                ...
                if (diemccValue instanceof String) {
                    if (diemccValue.isEmpty()) {
                        ...
                        try {
                            ...
                            gra.setDiemcc(null);
                            JOptionPane.showMessageDialog(null, "Điểm qt là số thực trong khoảng từ 1 đến 10, đéo phải chữ ");
                        } 
