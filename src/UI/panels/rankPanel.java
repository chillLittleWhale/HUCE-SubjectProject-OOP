...
public class rankPanel extends javax.swing.JPanel {
    ...
    private void setTable(){
        ...
        model.setColumnIdentifiers(new Object[]{
            ...
            "Điểm CK", "Điểm TB môn", "Điểm hệ 4", "Điểm chữ","Trường", "Tỉnh"
        });
        table1.getColumnModel().getColumn(0).setPreferredWidth(45); // hạng
        table1.getColumnModel().getColumn(1).setPreferredWidth(160); // tên
        table1.getColumnModel().getColumn(2).setPreferredWidth(60);  // điểm cc
        table1.getColumnModel().getColumn(3).setPreferredWidth(60); // điểm gk
        table1.getColumnModel().getColumn(4).setPreferredWidth(70); // điểm ck
        table1.getColumnModel().getColumn(5).setPreferredWidth(70); // điểm tbm hệ 10
        ...
        table1.getColumnModel().getColumn(8).setPreferredWidth(150); // trường
        table1.getColumnModel().getColumn(9).setPreferredWidth(85); //tỉnh
    ...
    private void showTable() throws SQLException{
        ...
        for(TopStudent account : dsTopSv) {
            table1.addRow(new ModelStudent(stt++, account.getAvatarImageIcon(), account.getName(), account.getSdt(),  account.getDiemcc(), account.getDiemgk(), account.getDiemck(), account.getDiemTBmon(), account.getDiemHe4(),account.getDiemchu(), account.getTruong(), account.getQueQuan()).toRowTable());
        } 
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hạng", "Tên", "Điểm CC", "Điểm GK", "Điểm CK", "Điểm TB môn", "Điểm hệ 4", "Điểm chữ", "Trường", "Tỉnh"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(cbBox_mon, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
        ...
        if (row >= 0 && col >= 0 && SwingUtilities.isRightMouseButton(evt)){
            ...
            if (profileCell instanceof ModelProfile) {
                ...
                if( new DAO_sv().dsMonChung(acc.getSdt(), profile.getSdt()).isEmpty()){
                    ...
                    compareView cpView = null;
                    try {
                        cpView = new compareView(acc, new DAO_sv().getAccBySdt(profile.getSdt()));
                    } catch (SQLException ex) {
                        Logger.getLogger(rankPanel.class.getName()).log(Level.SEVERE, null, ex);
                    }
