...
public class compareView extends javax.swing.JFrame {
    ...
    public compareView(Account acc1, Account acc2) throws SQLException {
        initComponents();
        this.acc1 = acc1;
        this.acc2 = acc2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(compareView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
